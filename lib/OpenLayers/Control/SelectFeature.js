...
OpenLayers.Control.SelectFeature = OpenLayers.Class(OpenLayers.Control, {
    ...
    unhighlight: function(feature) {
        ...
        layer.drawFeature(feature, (typeof baseLayerName !== "undefined" && baseLayerName) || feature.style || feature.layer.style ||
            "default");
    ...
    select: function(feature) {
        ...
        if(cont !== false) {
            ...
            if(cont !== false) {
				...
				this.onSelect.call(this.scope, feature, this.handlers.feature.evt);
            }
        }
    },
