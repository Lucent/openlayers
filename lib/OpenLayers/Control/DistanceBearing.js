...
OpenLayers.Control.DistanceBearing = OpenLayers.Class(OpenLayers.Control, {
    ...
    redraw: function(evt) {
        ...
        if (evt == null) {
			...
			if (planes && planes.features[1] && planes.features[1].geometry) {
				var point = new OpenLayers.Geometry.Point(lonLat.lon, lonLat.lat);
				var dist = point.distanceTo(planes.features[1].geometry);
        		...
        		var newHtml = Math.round(dist / MetersPerMile) + " miles at " + Math.round(bearing) + " degrees";
			} else {
				return;
			}
